...
SOURCES = \
	src/avanti.cpp src/units_conv.cpp src/units_conv.h
...
DEFINES = -DXPLM400=1 -DXPLM200=1 -DXPLM210=1 -DAPL=0 -DIBM=0 -DLIN=1
...
$(TARGET): $(BUILDDIR)/$(TARGET)/avanti.xpl


$(BUILDDIR)/$(TARGET)/avanti.xpl: $(ALL_OBJECTS64)
	@echo Linking $@
	mkdir -p $(dir $@)
